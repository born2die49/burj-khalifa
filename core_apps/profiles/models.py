...
class Profile(TimeStampedModel):
  ...
  occupation = models.CharField(verbose_name=_("Occupation"), max_length=20,choices = Occupation.choices, default=Occupation.TEANANT)
  phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+8801876381867")
  country_of_origin = models.CharField(verbose_name=_("Country"), max_length=180, default="Bangladesh")
