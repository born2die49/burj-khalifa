...
from core_apps.apartment.models import Apartment
...
class Issue(TimeStampedModel):
  ...
  apartment = models.ForeignKey(Apartment, on_delete=models.CASCADE, related_name="issues", verbose_name=_("Apartment"))
  reported_by = models.ForeignKey(User, on_delete=models.CASCADE, related_name="reported_by_issues", verbose_name=_("Reported by"))
  assigned_to = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="assigned_to_issues", verbose_name=_("Assigned to"))
  ...
  status = models.CharField(verbose_name=_("Status"), max_length=20, choices=IssueStatus.choices, default=IssueStatus.REPORTED)
  priority = models.CharField(verbose_name=_("Issue Description"), max_length=20, choices=Priority.choices, default=Priority.LOW)
