...
from .views import IssueListAPIView, IssueCreateAPIView, IssueDeleteAPIView, IssueUpdateAPIView, AssignedIssuesListView, MyIssuesListAPIView, IssueDetailAPIView
