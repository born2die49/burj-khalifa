...
from .serializers import DownvotePostSerializer, PopularTagSerializer, PostSerializer, ReplySerializer, TopPostSerializer, UpvotePostSerializer, PostByTagSerializer
...
class PostListAPIView(generics.ListAPIView):
  ...
  def get_queryset(self):
    return Post.objects.annotate(replies_count=Count("replies")).order_by("-upvotes", "-created_at")
