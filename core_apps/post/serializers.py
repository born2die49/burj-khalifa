...
from core_apps.post.models import Post, Reply
...
class BasePostSerializer(serializers.ModelSerializer):
  ...
  class Meta:
    model = Post
    fields = ["id", "title", "slug", "author_username", "is_bookmarked", "created_at", "updated_at", "view_count", "upvotes", "downvotes", "is_upvoted", "replies_count", "avatar"]
