...
from .views import BookmarkedPostListAPIView, UnBookmarkPostAPIView, PostListAPIView, PostCreateAPIView, PostDetailAPIView, PostUpdateAPIView, ReplyListAPIView, ReplyCreateAPIView, BookmarkPostAPIView, UpvotePostAPIView, DownvotePostAPIView, MyPostListAPIView, PopularTagsListAPIView, TopPostsListAPIView, PostsByTagListAPIView
