...
export default function CreateReportForm() {
	...
	const onSubmit = async (values: TReportCreateSchema) => {
		try {
			...
			toast.success(
				"Your report has been received. The management will take necessary steps ASAP",
			);
			reset();
			router.push("/profile");
		} catch (error) {
	...
	return (
		<main>
			...
			>
				...
				<Button
					type="submit"
					className="h4-semibold rounded-xl bg-eerieBlack dark:bg-pumpkin mt-2 w-full text-white"
					disabled={isLoading}
				>
