...
export const{ useSocialAuthenticationMutation, useActivateUserMutation, useLoginUserMutation, useLogoutUserMutation, useGetUserQuery, useRegisterUserMutation, useResetPasswordConfirmMutation, useResetPasswordRequestMutation, useRefreshJWTMutation } = authApiSlice