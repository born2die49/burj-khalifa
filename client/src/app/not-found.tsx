...
export default function NotFound() {
  return (
    <>
      <main className='flex h-screen flex-col items-center justify-center bg-black px-6 py-6 sm:py-24 lg:scroll-px-28'>
        <Image 
          src={shockedFace} 
          alt="Apartments" 
          height={200}
          ...
          <div className='mx-auto max-w-md text-center'>
            <h1 className='text-platinum text-4xl font-bold tracking-tight sm:text-5xl'>Page not found!</h1>
